...
(Očakávam že si logged in do GitHub účtu na VSCode.) 
...
4. Promptne ťa možno o link, možno o prijamy výber. Tam daj URL na toto repo (https://github.com/shiftyboi1/it-challenge-backend). Ak toto nefunguje, kontaktuj ma.
5. Poprosí vas o name, MUSÍTE ho pomenovať "origin"
6. Si connected. Teraz, pod "Changes" nájdeš graph. **Najprv klikni FETCH, potom PULL. TOTO JE POVINNÉ.**
...
```json
{
  "email": "AlfredDongel@hotmail.com",
  "password": "superheslo"
}
```
